...
class ImagenetModel(object):
    ...
    """
    #def __init__(self, synset_path, network_prefix, params_url=None, symbol_url=None, synset_url=None, context=mx.cpu(), label_names=None, input_shapes=[('data', (1,3,224,224))]):
    def __init__(self, synset_path='synset.txt', network_prefix='squeezenet_v1.1', params_url=None, symbol_url=None, synset_url=None, context=mx.cpu(), label_names=None, input_shapes=[('data', (1,3,224,224))]):
        ...
        self.mod.bind(for_training=False, data_shapes= input_shapes,  label_shapes=self.mod._label_shapes)
        print('bounded model')
...
if __name__ == "__main__":
    ...
    #parser.add_argument('--prefix', type=str, default='resnet-152', help='the prefix of the pre-trained model')
    #parser.add_argument('--label-name', type=str, default=None, help='the name of the last layer in the loaded network (usually softmax_label)')
    ...
    #mod = ImagenetModel(args.synset, args.prefix, label_names=None, params_url=args.params_url, symbol_url=args.symbol_url, synset_url=args.synset_url)
    #mod = ImagenetModel('synset.txt', 'resnet-152', label_names=None, params_url='', symbol_url=args.symbol_url, synset_url=args.synset_url)
    mod = ImagenetModel()
    print "predicting on "
   # if args.img == "cam":
